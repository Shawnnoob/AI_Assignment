...
ori_df = pd.read_csv("AI_Assignment/input/clean_df.csv", delimiter=',')
df = ori_df.copy()
df2 = pd.read_csv("AI_Assignment/input/normalized_df.csv", delimiter=',')
...
plt.savefig("AI_Assignment/graphs/dist_FixedAcidity_VolatileAcidity.png", dpi=300) # Saves 1st plot as png
...
plt.savefig("AI_Assignment/graphs/dist_CitricAcid_Alcohol.png", dpi=300) # Saves 2nd plot as png
...
plt.savefig("AI_Assignment/graphs/dist_ResidualSugar_Chlorides.png", dpi=300) # Saves 3rd plot as png

# Correlation Heatmap
corr_matrix = df.corr(numeric_only=True)
plt.figure(figsize=(15, 15))
sns.heatmap(corr_matrix, annot=True, cmap='coolwarm', fmt=".2f", linewidths=0.5).set(title = "Correlation Matrix")
plt.savefig("AI_Assignment/graphs/Correlation_Matrix.png", dpi=300)